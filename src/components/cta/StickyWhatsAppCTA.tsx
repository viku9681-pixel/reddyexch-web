...
export default function StickyWhatsAppCTA() {
  ...
  const message = encodeURIComponent(
    `Hi, I want to get my Gaming ID — ${process.env.NEXT_PUBLIC_SITE_URL ?? 'https://reddyexchgaming.com'}${pathname}`
  )

  // Device-aware URL — JS detects mobile at runtime
  ...
  return (
    <a
      ...
      className="wa-cta-sticky fixed bottom-6 right-4 z-40 flex flex-col items-center gap-1 bg-red text-white rounded-full px-4 py-3 shadow-2xl interactive"
